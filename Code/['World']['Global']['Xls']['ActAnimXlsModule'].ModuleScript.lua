...
local ActAnimXls = {
    ...
    [5] = {
        ...
        Mode = 2,
        ShowName = '大笑',
        anim = {'anim_human_sit_laughing_begin', 'anim_human_sit_laughing', 'anim_human_sit_laughing_end'},
        dur = {0.5, -1, 1},
        speed = 1.0,
        layer = 0,
        transIn = 0.2,
    ...
    [6] = {
        ...
        Mode = 2,
        ShowName = '鼓掌',
        anim = {'anim_human_sit_clap_begin', 'anim_human_sit_clap', 'anim_human_sit_clap_end'},
        dur = {0.3, -1, 0.2},
        speed = 1.0,
        layer = 0,
        transIn = 0.2,
