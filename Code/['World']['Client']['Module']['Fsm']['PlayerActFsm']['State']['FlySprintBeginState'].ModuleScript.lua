...
function FlySprintBeginState:initialize(_controller, _stateName)
    ...
    C.PlayerAnimMgr:CreateSingleClipNode('anim_man_hovertofly_01', 1.3, _stateName, 1)
    C.PlayerAnimMgr:CreateSingleClipNode('anim_woman_hovertofly_01', 1, _stateName, 2)
...
function FlySprintBeginState:OnEnter()
    ...
    C.PlayerAnimMgr:Play(self.stateName, 0, 1, 0.2, 0.2, true, false, 0.8)
end
