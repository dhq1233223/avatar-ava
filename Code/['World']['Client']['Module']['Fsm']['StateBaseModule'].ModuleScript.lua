...
function StateBase:AddTransition(_transitonName, _nextState, _dur, ...)
    local transiton = C.TransitonBase:new(self.stateName .. '_' .. _transitonName, _nextState, _dur)
...
function StateBase:AddAnyState(_transitonName, _dur, ...)
    local transiton = C.TransitonBase:new(self.stateName .. '_' .. _transitonName, self, _dur)
    transiton:InitConditions(...)
